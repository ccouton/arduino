...
//#define THN132N;
const byte TEMPERATURE_1_PIN = 10; 
const byte TRANSMITTER_PIN = 12;
...
void setup()
{
 ...
 //On initialise le capteur de temperature
  ...
  setChannel(OregonMessageBuffer, 0x30);
...
setTemperature(OregonMessageBuffer,13);
